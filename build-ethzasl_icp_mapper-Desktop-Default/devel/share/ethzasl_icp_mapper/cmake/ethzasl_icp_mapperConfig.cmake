...
if("TRUE" STREQUAL "TRUE")
  set(ethzasl_icp_mapper_SOURCE_PREFIX /home/yh/mine_ws/src/ethzasl_icp_mapping/ethzasl_icp_mapper)
  set(ethzasl_icp_mapper_DEVEL_PREFIX /home/yh/mine_ws/src/ethzasl_icp_mapping/build-ethzasl_icp_mapper-Desktop-Default/devel)
  ...
  set(ethzasl_icp_mapper_INSTALL_PREFIX /usr/local)
...
if(NOT "/home/yh/mine_ws/src/ethzasl_icp_mapping/build-ethzasl_icp_mapper-Desktop-Default/devel/include " STREQUAL " ")
  set(ethzasl_icp_mapper_INCLUDE_DIRS "")
  set(_include_dirs "/home/yh/mine_ws/src/ethzasl_icp_mapping/build-ethzasl_icp_mapper-Desktop-Default/devel/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'ethzasl_icp_mapper' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Francois Pomerleau <f.pomerleau@gmail.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'ethzasl_icp_mapper' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/yh/mine_ws/src/ethzasl_icp_mapping/ethzasl_icp_mapper/${idir}'.  Ask the maintainer 'Francois Pomerleau <f.pomerleau@gmail.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/yh/mine_ws/src/ethzasl_icp_mapping/build-ethzasl_icp_mapper-Desktop-Default/devel/lib;/home/yh/mine_ws/devel/lib;/opt/ros/indigo/lib)
...
set(ethzasl_icp_mapper_EXPORTED_TARGETS "ethzasl_icp_mapper_generate_messages_cpp;ethzasl_icp_mapper_generate_messages_lisp;ethzasl_icp_mapper_generate_messages_py")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${ethzasl_icp_mapper_dep}_FOUND)
      find_package(${ethzasl_icp_mapper_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${ethzasl_icp_mapper_dep} REQUIRED ${depend_list})
  endif()
